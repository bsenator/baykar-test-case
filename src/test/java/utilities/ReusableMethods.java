...
public class ReusableMethods {
    ...
    public static String getScreenshot(String name) throws IOException {
        ...
        String target = System.getProperty("user.dir") + "/test-output/" + branchName + "Screenshots/" + name + date + ".png";
    ...
    public static void clickButtonWithText(String ordinal, String buttonName) {
        ...
        WebElement ButtonClick = Driver.driver.findElement(By.xpath("(//*[text()=\"" + buttonName + "\"])[" + index + "]"));
        ButtonClick.click();
    }
    ...
    public static void buttonIsVisibleAndActive(String ordinal, String buttonName) {
        ...
        WebElement buttonElement = Driver.getDriver().findElement(By.xpath("(//*[text()=\"" + buttonName + "\"])[" + index + "]"));
    ...
    public static void verifyButtonWithText(String ordinal, String buttonName) {
        ...
        WebElement ButtonToVerify = Driver.driver.findElement(By.xpath("(//*[text()=\"" + buttonName + "\"])[" + index + "]"));
